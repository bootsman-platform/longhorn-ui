      ...
      <Form layout="horizontal">
        ...
        {getFieldDecorator('replicaAutoBalance', {
          initialValue,
            ...
            <Option key={'ignored'} value={'ignored'}>{t('updateReplicaAutoBalanceModal.options.ignored')}</Option>
            <Option key={'disabled'} value={'disabled'}>{t('updateReplicaAutoBalanceModal.options.disabled')}</Option>
            <Option key={'least-effort'} value={'least-effort'}>{t('updateReplicaAutoBalanceModal.options.leastEffort')}</Option>
            <Option key={'best-effort'} value={'best-effort'}>{t('updateReplicaAutoBalanceModal.options.bestEffort')}</Option>
          </Select>)}
        </FormItem>
      </Form>
    </ModalBlur>
