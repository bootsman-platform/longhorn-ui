...
function VolumeInfo({ t, selectedVolume, snapshotModalState, engineImages, hosts, currentBackingImage }) {
  let errorMsg = null
  ...
  return (
    <div>
      ...
      <div className={styles.row}>
        <span className={styles.label}>{t('volumeInfo.frontend.label')}</span>
      ...
      <div className={styles.row}>
        <span className={styles.label}>{t('volumeInfo.backupBlockSize.label')}</span>
        {formatMib(selectedVolume.backupBlockSize)}
      </div>
      <div className={styles.row}>
        <span className={styles.label}>{t('volumeInfo.dataEngine.label')}</span>
      ...
      <div className={styles.row}>
        <span className={styles.label}>
          <span>{t('volumeInfo.size.label')}</span>
      ...
      <div className={styles.row}>
        <span className={styles.label}>{t('volumeInfo.accessMode.label')}</span>
        {accessModeObject[selectedVolume.accessMode] ? accessModeObject[selectedVolume.accessMode] : ''}
      </div>
      {currentBackingImage ? <div>
        <div className={styles.row}>
          <span className={styles.label}>{t('volumeInfo.backingImage.label')}</span>
      ...
      <div className={styles.row}>
        <span className={styles.label}>{t('volumeInfo.encrypted.label')}</span>
