...
class Volume extends React.Component {
  ...
  render() {
    ...
    const volumeFilterProps = {
      ...
      fieldOption: [
        { value: 'name', name: t('volume.filter.fieldOptions.name') },
        { value: 'host', name: t('volume.filter.fieldOptions.node') },
        { value: 'status', name: t('volume.filter.fieldOptions.status') },
        ...
        { value: 'NodeTag', name: t('volume.filter.fieldOptions.nodeTag') },
        { value: 'DiskTag', name: t('volume.filter.fieldOptions.diskTag') },
