  ...
  return (
    <ModalBlur {...modalOpts}>
      <Form layout="horizontal">
        ...
        <FormItem label={t('createBackingImage.form.dataEngine.label')} hasFeedback {...formItemLayout}>
        ...
        <Spin spinning={tagsLoading}>
          <FormItem label={t('createBackingImage.form.nodeTag.label')} {...formItemLayout}>
        ...
        <Spin spinning={tagsLoading}>
          <FormItem label={t('createBackingImage.form.diskTag.label')} {...formItemLayout}>
